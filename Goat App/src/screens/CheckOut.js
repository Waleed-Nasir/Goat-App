...
const CheckOut = () => {
  ...
  return (
    <Layout Header={() => <Header showSlider={false} />}>
      ...
      <View style={styles.padding20}>
        <Address LeftPress={()=>navigation.navigate(SCREENS.SelectAddress)}/>
        ...
        />
        <Button title="Checkout" onPress={() => navigation.navigate(SCREENS.TrackStatus)} />
      </View>
    </Layout>
  );
};
...
const data = [
  ...
  {
    items: [
      {name: 'Total amount', ammount: 'Rs 57.45', style: {fontWeight: '700'}},
    ],
  },
  {
    isDivier: true,
